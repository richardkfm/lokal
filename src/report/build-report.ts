  ...
  return {
    ...
    method: {
      inputsUsed: [
        ...
        "workplace.clientOs",
        "workplace.deviceCount",
        "workplace.windowsOnlyApps",
        "workplace.deviceManagement",
        "workplace.peripheralDependency",
        "rates.internalDayRateCents",
        "rates.externalDayRateCents",
        "stack.seats",
        "stack.criticality",
        "stack.pain",
        "stack.urgency",
      ...
      notModelled: [
        ...
        "method.not_modelled.hosting_and_support_cost_of_the_new_stack",
        "method.not_modelled.productivity_during_changeover",
        "method.not_modelled.device_hardware_replacement",
        "method.not_modelled.which_linux_distribution",
      ],
